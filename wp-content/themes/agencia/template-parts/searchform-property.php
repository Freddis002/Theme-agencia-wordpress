...
<?php if (is_front_page()): ?>
    <div class="search-form__checkbox">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" <?php checked(!$isRent) ?> type="radio" name="property_category" id="<?= _x('buy','URL', 'agence') ?>" value="buy">
        <label class="form-check-label" for="<?= _x('buy','URL', 'agence') ?>"><?= __('Buy','agencia') ?></label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" <?php checked(!$isRent) ?> type="radio" name="property_category" id="<?= _x('rent','URL', 'agence') ?>" value="rent">
    ...
    <div class="form-group">
      ...
      <label for="city"><?= __('Ville', 'agencia')?></label>
    </div>
    <div class="form-group">
