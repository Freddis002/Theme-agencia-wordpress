 ...
 */
    ...
    add_action('init', function() {
        register_post_type('property', [
            ...
            /* has_archive sert a afficher la page archive-property
            rewrite= pour traduire le site + query _x('property','URL','agence') . '/(buy|rent)/?$', */
            'has_archive' =>true,
            'public' => true,
            'hierchical' => false,
...
/* Ajouter & types pour créer des biens */
        ...
        'add_or_remove_items'        => __('Add or remove Type'), 'agence',
        ...
        'back_to_items'              => __( '&larr; Back to Tags', 'agence' ),
    ...
    /**
     * Afficher le code ville et postal_code associé à ce contenu
     * 
     * @param WPW_Post|int $post
     */
    ...
    function agence_price($post = null): void {
        ...
        if (get_field('property_category',$post) === 'buy') {
            ...
            echo sprintf(__('%s $/mois', 'agence'), number_format_i18n(get_field('price',$post))); 
        }
    }
